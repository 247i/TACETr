...
/**
 * Strings for component 'survey', language 'ta', version '4.0'.
 *
 * @package     survey
 * @category    string
...
$string['modulename'] = 'ஆராய்வு';
$string['modulename_link'] = 'mod/survey/view';
$string['modulenameplural'] = 'ஆராய்வுகள்';
$string['name'] = 'பெயர்';
...
$string['report'] = 'ஆராய்வின் அறிக்கை';
