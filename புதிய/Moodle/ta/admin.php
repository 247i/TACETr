...
/**
 * Strings for component 'admin', language 'ta', version '4.0'.
 *
 * @package     admin
 * @category    string
...
$string['addcategory'] = 'புதிய பகுப்பு சேர்க்க';
$string['additionalhtml'] = 'கூடுதல் HTML';
$string['additionalhtml_heading'] = 'ஒவ்வொரு பக்கத்திலும் கூடுதல் HTML சேர்க்கப்பட வேண்டும்.';
$string['additionalhtmlfooter'] = 'BODY தொகுதி மூடப்படுவதற்கு முன்';
$string['additionalhtmlfooter_desc'] = 'இங்கே உள்ளிடப்படும் உள்ளடக்கம் ஒவ்வொரு பக்கத்தின் முடிவிற்கு முன்னால் சேர்க்கப்படும்.';
$string['additionalhtmlhead'] = 'HEAD க்குள்';
$string['additionalhtmlhead_desc'] = 'இந்த உள்ளடக்கம் ஒவ்வொரு பக்கத்திற்கும் HEAD குறிச்சொல்லின் அடிப்பகுதியில் சேர்க்கப்படும்.';
$string['additionalhtmltopofbody'] = 'BODY தொகுதி திறக்கும் போது';
$string['additionalhtmltopofbody_desc'] = 'இங்கே உள்ளிடப்படும் உள்ளடக்கம் ஒவ்வொரு பக்கத்திலும் உள்ள அதன் BODY தொகுதி திறந்த உடன் சேர்க்கப்படும்.';
$string['admincategory'] = 'பகுப்பு: {$a}';
$string['adminseesall'] = 'நிர்வாகியால் அனைவற்றையும் பார்க்கமுடியும்';
$string['adminseesallevents'] = 'நிர்வாகி பார்க்கக் கூடிய தொகுதிகள்';
$string['adminseesownevents'] = 'நிர்வாகிகளும் மற்ற பயனாளர் போல் பயன்படுத்த';
$string['advancedfeatures'] = 'மேம்பட்ட அம்சங்கள்';
$string['allcountrycodes'] = 'அனைத்து நாடுகளின் குறியீடுகள்';
$string['allowattachments'] = 'இணைப்புகளை அனுமதிக்கவும்';
$string['allowbeforeblock'] = 'அனுமதிக்கப்பட்ட பட்டியலை முதலில் செயல்படுத்த';
$string['allowcategorythemes'] = 'பகுப்பு தோற்றத்தை அனுமதி';
$string['allowcoursethemes'] = 'பாடத்திற்கான தோற்றத்தை அனுமதி';
$string['allowediplist'] = 'அனுமதிக்கப்பட்ட இணைய நெறிமுறை முகவரியின் பட்டியல்';
$string['allowemailaddresses'] = 'அனுமதிக்கப்பட்ட மின்னஞ்சல் களங்கள்';
$string['allowguestmymoodle'] = 'என் சுயதகவல் பக்கத்திற்கு விருந்தினர்களை அனுமதி';
$string['allowobjectembed'] = 'பதிப்பிட்ட வெளிப்பாடன வில்லைகளை அனுமதி';
$string['allowuserblockhiding'] = 'பயனாளர்கள் பகுதிகளை மறைக்க அனுமதி';
$string['allowusermailcharset'] = 'பயனாளர்கள் எழுத்துரு தொகுதியை தெரிவு செய்ய அனுமதி';
$string['allowuserthemes'] = 'பயனாளர்களுக்கான தோற்றத்தை அனுமதி';
$string['alternativefullnameformat'] = 'முழுபெயருக்கான மாற்று வடிவம்';
$string['appearance'] = 'தோற்றம்';
$string['aspellpath'] = 'அஸ்பெல்லுக்கான பாதை';
$string['authentication'] = 'நுழைவு முறைகள்';
$string['authpreventaccountcreation'] = 'பயனர் அடையாள அங்கீகாரத்தின் போது புது கணக்கு துவக்குவதை தடுக்கவும்';
$string['authpreventaccountcreation_help'] = 'ஒரு பயனர் இத்தளத்தில் தன் அடையாளத்திற்கு அங்கீகாரம் கோரும் போது ஏற்கனவே அவருக்கு கணக்கு இல்லையெனில் இத்தளத்தில் தன்னிச்சையாக உருவாக்கப்படும். LDAP போன்று வேறு சில அடையாள அங்கீகார வழிகள் பயன்படுத்தும் போது முன்னதாகவே இத்தளத்தில் கணக்கு வைத்திருப்பவர்களுக்கு மட்டும் அனுமதி வழங்க வேண்டுமாயின் இந்த தேர்வை பயன்படுத்தவும்.

இச்சூழ்நிலைகளில், புதிய கணக்குகளை பயனர் தாமாக அல்லது பயனர் பதிவேற்ற அம்சத்தை பயன்படுத்தி உருவாக்க வேண்டும்.

குறிப்பு: இந்த அமைப்பு MNet அடையாள அங்கீகார முறைக்கு பொருந்தாது.';
$string['authsettings'] = 'அடையாள அங்கீகரிப்பு முறையை நிர்வக்கிக்க';
$string['autolang'] = 'மொழியை தன்னிச்சையாக கண்டறிய';
$string['autologinguests'] = 'விருந்தினரின் தன்னிச்சையாக உள்நுழைவு';
$string['availablelicenses'] = 'உரிமங்கள்';
$string['backgroundcolour'] = 'ஊடுருவக் கூடிய நிறம்';
$string['backups'] = 'ஆதாரநகல்கள்';
$string['badwordsconfig'] = 'தகாத வார்த்தைகளை காற்புள்ளி வைத்து பட்டியலிடவும்.';
$string['badwordsdefault'] = 'உங்களுடைய வடிவமைக்கப்பட்ட பட்டியல் காலியாக இருந்தால் மொழிப்பகுதியிலிருந்து ஒரு கொடா நிலைப் பயன்படுத்தப்படும்';
$string['badwordslist'] = 'தகா வார்த்தைப் பட்டியல்';
$string['blockediplist'] = 'தடைசெய்யப்பட்ட இணைய நெறி முகவரிகளின் பட்டியல்';
$string['blockinstances'] = 'உதாரணங்கள்';
$string['blockmultiple'] = 'பலதரப்பட்ட';
$string['blocksettings'] = 'தொகுதிகளை நிர்வகிக்க';
$string['bloglevel'] = 'வலைப்பதிவின் தெரிவுநிலை';
$string['bookmarkadded'] = 'புத்தகக் குறியீடு சேர்க்கபட்டது';
$string['bookmarkalreadyexists'] = 'நீங்கள் ஏற்கனவே இந்தப்பக்கத்தைப் புத்தகக்குறியிட்டில் வைத்துள்ளீர்கள்';
$string['bookmarkdeleted'] = 'புத்தக்கக் குறியீடு நீக்கப்பட்டுவிட்டது';
$string['bookmarkthispage'] = 'இந்தப் பக்கத்தை புத்தக்கக் குறியீடு செய்';
$string['cacheapplicationhelp'] = 'தற்காலிகமாக சேமிக்கப்பட்ட தகவல்கள் அனைத்து பயன்பாட்டார்களாலும் பகிரப்படும். இத்தகவல் தீர்மானிக்கபட்ட காலவரையில் காலாவதியாகும்.';
$string['cachejs'] = 'Javascript நிரல் குறியீடுகளை தற்காலிகமாக சேமி.';
$string['cachejs_help'] = 'Javascript நிரல் குறியீடுகளின் தற்காலிக சேமிப்பு மற்றும் சுருக்கம் இத்தளத்தின் செயல்திறனை வெகுவாக அதிகரிக்கும். பயன்பாட்டிலுள்ள தளத்திற்க்கு இந்த அமைப்பு பரிந்துரைக்கப்படுகிறது. மென்பொருள் உருவாக்கம் செய்பவர்கள் வேண்டுமானால் இவ்வமைப்பை நிறுத்தி வைக்க விரும்பலாம்.';
$string['cacherequest'] = 'தற்காலிக சேமிப்பு தகவலை பயன்படுத்த கோரிக்கை.';
$string['cachesession'] = 'இந்த அமர்வின் தற்காலிக தகவல் சேமிப்பு.';
$string['cachesettings'] = 'தற்காலிக தகவல் சேமிப்பு அமைப்புகள்';
$string['caching'] = 'தற்காலிக தகவல் சேமிப்பு முறை';
$string['calendar_weekend'] = 'வாரத்தின் கடைசி நாட்கள்';
$string['calendarsettings'] = 'நாள்காட்டி';
$string['calendartype'] = 'நாட்காட்டி வகைகள்';
$string['calendartype_desc'] = 'முழுதளத்திற்கும் ஒரு கொடா நாட்காட்டி வகையை தேர்வு செய்க. இந்த தேர்வை பயனர்கள் தங்கள் சுயவிவரப் பக்கத்தில் மாற்றி அமைக்கலாம்.';
$string['cannotdeletemodfilter'] = 'உங்களால் \'{$a->filter}\'-ஐ நீக்க இயலாது. ஏனென்றால் இது \'{$a->module}\'-ன் பகுதி.';
$string['cannotuninstall'] = '{$a}-ஐ நீக்க இயலாது.';
$string['change'] = 'மாற்றம்';
$string['checkboxno'] = 'இல்லை';
$string['checkboxyes'] = 'ஆம்';
$string['choosefiletoedit'] = 'திருத்தம் செய்ய வேண்டிய கோப்பை தேர்வு செய்க';
...
$string['clistatusdisabled'] = 'நிலை: முடக்கப்பட்டுள்ளது';
$string['clistatusenabled'] = 'நிலை: செயல்பாட்டில் உள்ளது';
$string['clistatusenabledlater'] = 'நிலை: CLI பராமரிப்பு முறைமை {$a}-ன் போது செயல்பாட்டிற்கு வரும்.';
...
$string['cliupgradefinished'] = 'Command line வெற்றிகரமாக மேம்படுத்தப்பட்டது.';
$string['cliupgradenoneed'] = 'நிறுவப்பட்டுள்ள பதிப்பான {$a}-க்கு மேம்பாடு தேவையில்லை. இங்கே வந்தமைக்கு நன்றி.';
$string['cliyesnoprompt'] = 'தட்டச்சு செய்யவும். ஆம் என்றால் y (அல்லது) இல்லை என்றால் n';
$string['commentsperpage'] = 'ஒவ்வொரு பக்கத்திலும் எத்தனை கருத்துக்கள் காண்பிக்கலாம்?';
$string['commonactivitysettings'] = 'பொதுவான அமைப்புகள்';
$string['commonsettings'] = 'பொதுவான அமைப்புகள்';
$string['componentinstalled'] = 'பகுதி நிறுவப்பட்டது';
...
$string['configallowcoursethemes'] = 'நீங்கள் இதை செயல்படுத்தினால் பாடங்கள் உங்கயுடைய தோற்றங்களை வடிவமைத்துக் கொள்ள இயலும்.பாடங்களின் தோற்றங்கள் மற்ற தோற்றத் தேர்வுகளை (பகுதி பயனாளர் அல்லது கால வரை தோற்றங்கள்) மாற்றியமைக்கவள்ளது.';
...
$string['configsectioninterface'] = 'இடைப்பட்ட';
$string['configsectionmail'] = 'அஞ்சல்';
$string['configsectionmaintenance'] = 'பராமரிப்பு';
$string['configsectionmisc'] = 'இதர';
$string['configsectionoperatingsystem'] = 'இயக்க முறைமை';
$string['configsectionpermissions'] = 'அனுமதிகள்';
$string['configsectionrequestedcourse'] = 'தேவையான பாடங்கள்';
...
$string['configstartwday'] = 'வாரத்தத்தை தொடங்கு';
...
$string['configvariables'] = 'மாறிலிகள்';
...
$string['coursemgmt'] = 'பாடத்தைச் சேர்/தொகு';
$string['courseoverview'] = 'பாடத்தின் விளக்கம்';
$string['courserequests'] = 'பாட வேண்டுகோள்';
$string['courses'] = 'பாடங்கள்';
$string['coursesperpage'] = 'ஒரு பக்கத்திற்கு ஒரு பாடத்திட்டம்';
...
$string['docroot'] = 'மூடூலின் ஆவணங்கள்';
$string['doctonewwindow'] = 'புதிய திரையில் திற';
$string['download'] = 'கீழிறக்கம்';
$string['edithelpdocs'] = 'உதவி ஆவணத்தை சரிசெய்ய';
$string['editlang'] = '<b>சரிசெய்</b>';
...
$string['editstrings'] = 'வார்த்தைகளை சரிசெய்ய';
$string['enablecourserequests'] = 'Enable course requests';
$string['enableglobalsearch'] = 'Enable global search';
$string['enablerecordcache'] = 'Enable Record Cache';
$string['enablerssfeeds'] = 'Enable RSS feeds';
$string['enablestats'] = 'புள்ளியலைச் செயல்படுத்து';
...
$string['errorsetting'] = 'அமைப்பு  சேமிக்கப்படவில்லை';
$string['errorwithsettings'] = 'Some settings were not changed due to an error:';
$string['experimental'] = 'சோதனைக்காக';
$string['extendedusernamechars'] = 'வெளிப்புற எழுத்துருவை பயனாளர் பெயருக்கு அனுமதி';
$string['filterall'] = 'வடிகட்டிய அனைத்து வார்த்தைகள்';
...
$string['filtersettings'] = 'வடிகட்டியின் அமைப்பு';
$string['filteruploadedfiles'] = 'எற்றக்கூடிய கோப்புகளை வடிகட்டுக';
...
$string['helpsitemaintenance'] = 'அடுத்த நிலை உயர்வுக்கு மற்றும் இதர செயல்களுக்காக';
$string['helpstartofweek'] = 'நாள்காட்டியில்  எந்த நாள் வாரத்தின் முதலில் தொடங்குகிறது?';
...
$string['hiddenuserfields'] = 'பயனாளர் புலத்தை அனுமதி';
$string['htmleditor'] = 'ஹச்டிஎம்எல் பதிப்பி';
$string['http'] = 'ஹச்டிடிபி';
$string['httpsecurity'] = 'ஹச்டிடிபி பாதுகாப்பாளர்';
$string['includemoduleuserdata'] = 'Include module user data';
$string['incompatibleblocks'] = 'Incompatible blocks';
$string['invalidsection'] = 'பிரிவு இல்லை';
...
$string['locationsettings'] = 'இடம் பற்றிய குறிப்புகள்';
$string['log'] = 'செயலறிக்கை';
$string['loglifetime'] = 'Keep logs for';
$string['maintfileopenerror'] = 'கையாளும் கோப்புகள் திறப்பதில் பிழை!';
$string['maintinprogress'] = 'கையாளக்கூடிய முறை...';
$string['managelang'] = '<b>மேலாண்மை</b>';
$string['maxbytes'] = 'மேலேற்றுதலின் அதிகப்படியான அளவு';
...
$string['misc'] = 'மற்றவை';
$string['modulesecurity'] = 'பகுதி பாதுகாப்பாளர்';
...
$string['noresults'] = 'எந்த முடிவும் இல்லை';
...
$string['opentowebcrawlers'] = 'கூகுளைத் பயன்படுத்து';
...
$string['perfdebug'] = 'செயல்களின் தகவல்';
$string['performance'] = 'செயல்';
...
$string['protectusernames'] = 'திட்டத்தின் பயனாளர்பெயர்';
...
$string['sitemaintenancemode'] = 'செப்பனிடக் கூடிய செயல்நிலையில்';
...
$string['sitepolicy_help'] = 'If you have a site policy that all users must see and agree to before using this site, then specify the URL to it here, otherwise leave this field blank.  The URL can point to anywhere - one convenient place would be a file in the site files.  eg http://yoursite/file.php/1/policy.html';
...
$string['stickyblocksmymoodle'] = 'என்னுடைய மூடுல்';
$string['stickyblockspagetype'] = 'பக்க வகையை செம்மைப்படுத்த';
$string['systempaths'] = 'அமைப்புக்கான பாதை';
...
$string['themelist'] = 'முகப்பு தோற்றத்தின் பட்டியல்';
$string['themeselector'] = 'முகப்பு தோற்றத்தைத் தேர்ந்தெடு';
$string['themesettings'] = 'முகப்பு தோற்ற வடிவமைப்பு';
$string['therewereerrors'] = 'உங்களுடைய தரவில் பிழை உள்ளது';
...
$string['updateaccounts'] = 'ஏற்கெனவேயுள்ள கணக்கை சரிசெய்தல்';
...
$string['userlist'] = 'பயனாளர் வரிசையைக் காண';
