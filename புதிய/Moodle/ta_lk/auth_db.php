...
/**
 * Strings for component 'auth_db', language 'ta_lk', version '4.3'.
 *
 * @package     auth_db
 * @category    string
...
$string['auth_dbdeleteuser'] = 'நீக்கப்பட்ட பயனாளர் {$a->name} id {$a->id} ';
...
$string['auth_dbinsertuser'] = 'உள்ளிடப்பட்ட பயனாளர் {$a->name} id {$a->id}';
...
$string['auth_dbreviveduser'] = 'புதுப்பிக்கப்பட்ட பயனாளர் {$a->name} id {$a->id}';
...
$string['auth_dbsuspenduser'] = 'நிறுத்தப்பட்ட பயனாளர் {$a->name} id {$a->id}';
...
$string['auth_dbupdatinguser'] = 'பயனாளர் {$a->name} id {$a->id} ஐ இற்றைப்படுத்தல்';
...
$string['pluginname'] = 'புறத் தரவுத்தளம்';
