...
/**
 * Strings for component 'auth_ldap', language 'ta_lk', version '4.3'.
 *
 * @package     auth_ldap
 * @category    string
...
$string['auth_ldap_bind_dn_key'] = 'வித்தியாசப்படுத்தப்பட்ட பெயர்';
...
$string['auth_ldap_create_error'] = 'LDAP இல் பயனாளரை உருவாக்குவதில் வழு';
...
$string['auth_ldap_groupecreators_key'] = 'குழு உருவாக்குபவர்கள்';
...
$string['auth_ldap_user_exists'] = 'LDAP பயனாளர் பெயரானது ஏற்கனவே இருக்கிறது.';
...
$string['auth_ntlmsso_enabled_key'] = 'இயலுமைப்படுத்துக';
$string['auth_ntlmsso_ie_fastpath_key'] = 'MS IE விரைவான பாதையா?';
$string['auth_ntlmsso_type_key'] = 'அத்தாட்சிப்படுத்தல் வகை';
$string['connectingldap'] = 'LDAP சேவையகத்திற்கு இணைக்கப்படுகிறது...';
$string['creatingtemptable'] = 'தற்காலிக {$a} அட்டவணை உருவாக்கல்';
$string['nodnforusername'] = 'user_update_password() இல் வழு. DN இல்லை: {$a->username}';
$string['noemail'] = 'உங்களுக்கு மின்னஞ்சல் அனுப்ப முயற்சிக்கப்பட்டது, ஆனால் பயனளிக்கவில்லை.';
$string['noupdatestobedone'] = 'எந்தவொரு இற்றைப்படுத்தல்களும் செய்யப்படவில்லை';
$string['nouserentriestoremove'] = 'எந்தவொரு பயனாளர் பதிவுகளும் அகற்றப்படவில்லை';
$string['nouserstobeadded'] = 'எந்தவொரு பயனாளர்களும் சேர்க்கப்படவில்லை';
$string['ntlmsso_isdisabled'] = 'NTLM SSO செயலற்றதாக்கப்பட்டிருக்கிறது.';
$string['ntlmsso_unknowntype'] = 'தெரியாத ntlmsso வகை!';
$string['pluginname'] = 'LDAP சேவையகம்';
$string['pluginnotenabled'] = 'உட்செருகல் இயலுமைப்படுத்தப்படவில்லை!';
$string['renamingnotallowed'] = 'LDAP இல் பயனாளர் பெயரை மாற்றல் அனுமதிக்கப்படவில்லை';
$string['updatepasserror'] = 'user_update_password() இல் வழு. வழு குறி: {$a->errno}; வழு எழுத்துச்சரம்: {$a->errstring}';
