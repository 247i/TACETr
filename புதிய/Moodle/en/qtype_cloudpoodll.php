...
/**
 * Strings for component 'qtype_cloudpoodll', language 'en', version '4.0'.
 *
...
$string['pluginname_help'] = 'In response to a question the respondent records an answer, video or audio. The Cloud Poodll question will not be assigned a grade until it has been reviewed by a teacher and manually graded.';
...
$string['pluginnamesummary'] = 'Students submit audio or video recordings as response to a question. The text can be transcribed after a short delay.';
