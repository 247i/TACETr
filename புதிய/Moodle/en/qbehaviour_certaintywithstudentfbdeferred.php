...
/**
 * Strings for component 'qbehaviour_certaintywithstudentfbdeferred', language 'en', version '4.0'.
 *
...
$string['allegederror'] = 'Presumed errors';
$string['allegederror_details'] = 'Presumed error ({$a})';
$string['almostsure'] = 'Almost sure';
$string['almostsure_details'] = 'almost sure';
$string['answer'] = 'your answer was {$a}';
$string['answercategorydetails'] = 'you were {$a->certainty} and {$a->youranswer}';
$string['behavioursummary'] = 'Certainty summary';
$string['correct'] = 'correct';
$string['correctanswers'] = 'Correct answers';
$string['declaredignorance'] = 'Declared ignorance';
$string['declaredignorance_details'] = 'Declared ignorance (you answered at random, whether your answer was correct or incorrect does not matter)';
...
$string['ndeclaredignorance'] = 'Declared ignorance: {$a}';
